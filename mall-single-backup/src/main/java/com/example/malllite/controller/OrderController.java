...
public class OrderController {
    ...
    @GetMapping("/{id}")
    public BaseResponse<OrderVO> getOrderById(@PathVariable Long id) {
    ...
    @PostMapping("/pay/{id}")
    public BaseResponse<Boolean> payOrder(@PathVariable Long id) {
    ...
    @PostMapping("/ship/{id}")
    public BaseResponse<Boolean> shipOrder(@PathVariable Long id) {
        return ResultUtils.success(orderService.shipOrder(id));
    }

    @PostMapping("/complete/{id}")
    public BaseResponse<Boolean> completeOrder(@PathVariable Long id) {
